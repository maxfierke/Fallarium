...
int ReadJPad(int n)
{
  ...
  int rightKeys[8] =
  {
		  ...
		  ALLEGRO_KEY_QUOTE, ALLEGRO_KEY_ENTER, ALLEGRO_KEY_OPENBRACE, ALLEGRO_KEY_CLOSEBRACE
  };
  int leftKeys[8] =
  {
		  ALLEGRO_KEY_R, ALLEGRO_KEY_F, ALLEGRO_KEY_D, ALLEGRO_KEY_G, ALLEGRO_KEY_A,
		  ALLEGRO_KEY_S, ALLEGRO_KEY_Q, ALLEGRO_KEY_W
  };
