...
void textout(struct ALLEGRO_FONT const *font, const char *s, int x, int y,
		ALLEGRO_COLOR c);
void textout_centre(struct ALLEGRO_FONT const *font, const char *s, int x,
		int y, ALLEGRO_COLOR c);
void textprintf(struct ALLEGRO_FONT const *f, int x, int y, ALLEGRO_COLOR color,
		const char *fmt, ...);
...
void play_sample(struct ALLEGRO_SAMPLE *spl, int vol, int pan, int freq,
		int loop);
